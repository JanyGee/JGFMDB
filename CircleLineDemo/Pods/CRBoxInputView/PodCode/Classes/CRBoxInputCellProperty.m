...
- (instancetype)init
{
    ...
    if (self) {
        ...
        // UI
        self.borderWidth = (2);
        self.cellBorderColorNormal = [UIColor colorWithRed:232/255.0 green:232/255.0 blue:232/255.0 alpha:1];
        self.cellBorderColorSelected = [UIColor colorWithRed:255/255.0 green:117/255.0 blue:23/255.0 alpha:1];
        ...
        self.cellCursorColor = [UIColor colorWithRed:255/255.0 green:117/255.0 blue:23/255.0 alpha:1];
        ...
        // label
        self.cellFont = [UIFont systemFontOfSize:25];
