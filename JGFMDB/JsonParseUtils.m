    ...
    for (id key in dict) {
        ...
        if ([propertyType isEqualToString:@"NSString"] \
            ...
            if ([propertyType isEqualToString:@"NSString"] == NO &&
                ...
                [JsonParseUtils populateObject:childObj fromDictionary:value exclude:nil];
                if ([key isEqualToString:@"id"]) {
...
+(id)populateObject:(id)obj fromDictionary:(NSDictionary *)dict {
    obj = [JsonParseUtils populateObject:obj fromDictionary:dict exclude:nil];
...
+ (id)objectWithClass:(Class)cls fromDictionary:(NSDictionary *)dict {
    ...
    [JsonParseUtils populateObject:obj fromDictionary:dict];
    return obj;
}
...
+(NSArray *)arrayOfClass:(Class)cls fromArray:(NSArray *)array {
    NSMutableArray *mutableArray = [JsonParseUtils mutableArrayOfClass:cls fromArray:array];
...
+(NSMutableArray *)mutableArrayOfClass:(Class)cls fromArray:(NSArray *)array {
    ...
    for (id item in array) {
        ...
        id obj = [JsonParseUtils objectWithClass:cls fromDictionary:item];
...
+(id)decodeObject:(Class)clazz from:(id)object{
    if (object && (clazz!=NULL)) {
        if(clazz == [NSDictionary class]||clazz == [NSArray class]){
            ...
            return [JsonParseUtils objectWithClass:clazz fromDictionary:object];
